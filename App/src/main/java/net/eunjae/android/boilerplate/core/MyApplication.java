...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        PushService.setDefaultPushCallback(this, StartActivity_.class);
        PushService.subscribe(this, BuildConfig.buildType.toString().toLowerCase(), StartActivity_.class);
