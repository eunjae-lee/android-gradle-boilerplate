...
/**
 * An {@link android.app.Activity} that displays a list of image files for one category; clicking on one opens
...
public class CategoryViewActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    adjective = ContainerHolder.getContainer().getString(MainActivity.ADJECTIVE_KEY);
